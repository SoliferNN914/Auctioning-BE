...
describe('GET *', () => {
  test('404: responds with error when given invalid endpoint', () => {
    return request(app)
      .get('/fjdihdkfkhudz')
      .expect(404)
      .then((response) => {
...
describe('GET /api/businesses/:business_id', () => {
  ...
  test('404: responds with an error when given a valid but non-existent business_id', () => {
    return request(app)
  ...
  test('400: responds with an error when given an invalid business_id', () => {
    return request(app)
...
describe('POST /api/users', () => {
  ...
  test('400: responds with an error when missing required keys', () => {
    const userToAdd = {
      postcode: 'M3 2BW',
    }
    return request(app)
  ...
  test('400: responds with an error when given a username that already exists', () => {
    const userToAdd = {
      username: 'smink123',
      postcode: 'B47 5HQ',
    }
  ...
  test('400: responds with a Bad Request error when any of the keys are incorrectly named', () => {
    const userToAdd = {
      name: 'smink123',
      city: 'B47 5HQ',
    }
  ...
  test('400: responds with a Bad Request error when any of the values are empty strings', () => {
    const userToAdd = {
      username: '',
      postcode: '',
    }
...
describe('GET /api/users/:user_id', () => {
  ...
  test('404: responds with an error when given a valid but non-existent user_id', () => {
    return request(app)
      .get('/api/users/1111')
      .expect(404)
      .then((response) => {
...
describe('PATCH /api/users/:user_id/bidding', () => {
...
describe('GET /api/auctions/:auction_id', () => {
  ...
  test('404: responds with an error when given a valid but non-existent auction_id', () => {
    return request(app)
  ...
  test('400: responds with an 400 when given an invalid auction_id', () => {
    return request(app)
...
describe('PATCH /api/auctions/:auction_id', () => {
  ...
  test('200: responds with updated auction details, not adding user if user already involved', () => {
    const updatedAuctionDetails = {
      current_bid: 5,
      user_id: 1,
    }
...
describe('GET /api/auctions/event/:event_id', () => {
  ...
  test('404: responds with an error when given a valid but non-existent event_id', () => {
    return request(app)
  ...
  test('400: responds with an 400 when given an invalid event_id', () => {
    return request(app)
...
describe('GET /api/auctions/user/:user_id', () => {
...
describe('GET /api/auctions/won/:user_id', () => {
...
describe('GET /api/events/:event_id', () => {
  ...
  test('400: responds with an error when given an invalid event_id', () => {
    return request(app)
      .get('/api/events/jdks')
      .expect(400)
      .then((response) => {
...
describe('PATCH /api/events/seating/:event_id', () => {
...
describe('GET /api/events/near/:user_id', () => {
...
describe('GET /api/events/business/:business_id', () => {
